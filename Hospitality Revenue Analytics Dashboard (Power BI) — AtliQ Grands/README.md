...
- [Executive Summary](#executive-summary)
  - [Revenue Trend by Hotel Type (Business vs Luxury)](#revenue-trend-and-category-mix-business-vs-luxury)
  - [What Affects Revenue More: Occupancy or Room Price?](#revpar-drivers-occupancy-vs-adr-what-actually-moves-revpar)
  - [Demand Comparison: Weekdays vs Weekends](#weekday-vs-weekend-performance-demand-pattern)
  - [Booking Loss Analysis (Realisation Rate)](#booking-leakage-realisation--Luxury-vs-business)
  - [Performance by Booking Platform](#sales-by-platforms--channels-booking-platform-performance)
